...
<form action="ChangePassword.jsp">
  <div class="container">
    ...
    <input type="password" placeholder="Enter New Password" id="password1" name="password" required>

     <label for="psw-repeat"><b>Confirm Password</b></label>
    <input type="password" placeholder="Confirm Password" id="password2" name="psw-repeat" required>
