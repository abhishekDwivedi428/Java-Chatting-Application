...
<form action="UpdateDetails.jsp">
  <div class="container">
    ...
    <input type="text" placeholder="<%=session.getAttribute("user_name")%>" name="username" >

    <label for="psw"><b>Phone Number</b></label>
    <input type="text" placeholder="+91 <%=session.getAttribute("mble")%>" name="phonenumber" required>

    
    <a href="UploadImageForm.jsp" style="text-decoration:none"><h3 style="font-weight: bold; color:darkolivegreen">Update Image</h3></a><br>

    <a href="ChangePasswordform.jsp" style="text-decoration:none"><h3 style="font-weight: bold; color: red">Change Password</h3></a>
    <hr>
    

    <button type="submit" class="registerbtn">Updates</button>
  </div>
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li><a href="#"><i class="fa fa-bar-chart"></i><span>Invite</span></a></li>
