		...
		$(document).ready(function() {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.readAsDataURL(input.files[0]);
                 ...
                 <div class="abhishek">
<div style="margin-left:400px; margin-top:80px;height:55px;">
    <h2>Create a Network</h2> <br> <br>
                <form action="NetworkImgUpload.jsp"  method="post" enctype="multipart/form-data"
                      onchange="readURL()">
               ...
               <input type='file' id="file" required  name="file-upload" accept=".jpg,.png" onchange="readURL(this);" /><br>
                     <img id="blah" src="#" alt="your image"  style="width: 300px; height: 300px;" />
                </div>
                <br>

                <div class="u-form-group1">
                    <input type="network_name" placeholder="Network Name" required name="network_name" onkeyup="sendInfo()">
                    <br>
