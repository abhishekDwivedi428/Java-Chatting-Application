...
<form action="Upload_post.jsp"  method="post">
             ...
             <div class="postdisplay2">
                 <strong>   <h2 style="padding-left: 30px; padding-top: 10px; font-size: 25px; ">Network Name: 
        ...
        <%
            ...
            <%=Network_name%>
                     ...
                     <% session.setAttribute("Network_name",Network_name);%></Strong>
            <% Date date =new Date(); %>
            
                    <h4 style="float:right;margin-top:-15px"><%=date%></h4>

                        <img  class="test" src="./images/image" alt="Avatar" >

                        <div class="postdisplay4">
                            <h4>
                                <textarea style="width: 600px; height: 260px; background-color: azure;"  placeholder="what's  in your mind ?" name="post_content" required></textarea>
                            </h4>
                        </div>
                        <div class="post">
