...
<!-- script-for sticky-nav -->
       ...
       <div class="test" style="margin-left:400px; margin-top:80px;height:90px;">
            ...
            <br>
            <br>
            <form action="SendInviteMail.jsp" method="post" >
                <h3 style="font-weight: bold">Select Network for invite</h3><br>
                <br>
                <br>
                <%
...
PreparedStatement ps=con.prepareStatement(sql);
 ...
 %>
 <select name="nw_name" required="required" style= " font-size: 15px; margin-left:-0px; margin-top:-175px;height:38px; width: 200px;" >
