...
<!-- script-for sticky-nav -->
  ...
  <div class="container">
      <h1>List of Created Networks</h1>
            <br>
            <br>
    ...
    <%
         ...
         PreparedStatement ps=con.prepareStatement("Select network_name from networks_master where user_id=?");
  ...
  <select name="nw_name" required style= " font-size: 15px; height:38px; width: 200px;" >
...
catch(Exception ex)
{
    ex.printStackTrace();
         ...
         %>
         <br>
         <button >Go to Network Settings</button>      
<button id ="btnprofile" formaction="Network_Home.jsp">Network Home</button>
  </div>
</form>
</div>
